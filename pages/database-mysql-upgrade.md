# Using MySQL 5.1 or MySQL 5.5 with Cloud

The MySQL 5.1 and MySQL 5.5 databases are now candidates for testing on Engine Yard Cloud. Read this page if you want to participate in the Cloud MySQL 5.1/5.5 Alpha program.

**Important!** MySQL 5.1/5.5 on Cloud are Alpha features. Always test in a development or staging environment.


### Process

The process for setting up and running your Cloud application on MySQL 5.1 or MySQL 5.5 depends on your current environment.

* _Is this a new application?_ Then do these tasks:

   * [Get access to the Alpha program and ey-beta-talk group][2]  
   * [Set up an Cloud application to use MySQL 5.1/5.5 in Alpha][3]  

* _Are you running Cloud with MySQL 5.0.x now?_ Then, do these tasks:  

    * [Get access to the Alpha program and ey-beta-talk group][2]  
    * [Set up an Cloud application to use MySQL 5.1/5.5 in Alpha][3]  
    * [Dump and restore an existing MySQL 5.0.x database][4]
 
* _Are you migrating a MySQL-based application to Cloud from another platform?_ Then, do these tasks:  
...
### To access the Cloud MySQL 5.1/5.5 Alpha program
...
<h2 id="topic3"> Set up an Cloud application to use MySQL 5.1/5.5 in Alpha </h2>
...
### To use MySQL 5.1/5.5 with Cloud in Alpha
...
If you are currently running a MySQL database (5.0.x), you need to dump the database, create a new MySQL environment in Cloud, move the database dump file to the database server, and finally load the file into the MySQL database.  
...
2. 	Move the output file to the new environment. 
	...
	**Note** The new server is the database instance assigned for your MySQL 5.1/5.5 Alpha Cloud environment that you created [above][3].
...
<tr>
    <td>database tasks in Cloud</td><td>[[Database Home|database_home]] (Many of the tasks apply to MySQL 5.1 and 5.5 as well as to MySQL 5.0.)</td>
  </tr>
<tr>
...
<tr>
    <td>SSH public keys</td><td>[[Using SSH on Cloud|ssh-intro]] </td>
  </tr>
<tr>
    <td>Deleting an environment</td><td>[[Delete an environment on Cloud|environment-delete]] documentation </td>
  </tr>
</table>

<h2 id="topic6"> Troubleshooting</h2>

This table contains troubleshooting tips related to the Cloud MySQL Alpha program.
