...
This guide assumes that you have already [[signed up for an EY Cloud Account|sign-up-for-engine-yard-appcloud]] If you have not yet done so, go ahead and get started now -> [[Engine Yard Cloud|http://cloud.engineyard.com]]

## Application Information

When you first sign up for Cloud you will need to configure your first application. 
...
1. In the Cloud Show Deploy Keys page, copy the git deploy key.

    ![Where to find your deploy key on Cloud](images/3sm.png)
