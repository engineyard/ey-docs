...
* <a href=#FAQ2>Is there any shared storage on Cloud?</a>
* <a href=#FAQ3>Do you offer Email services on Cloud?</a>
* <a href=#FAQ4> Can Cloud host my DNS?</a>
...
* <a href=#FAQ9> Is PostgreSQL Supported on Cloud?</a>
* <a href=#FAQ11> What scale of apps are appropriate for Cloud?</a>
* <a href=#FAQ12> What types of applications run on Cloud?</a>
...
* <a href=#FAQ20> Are there reserved names in Cloud? </a>
* <a href=#FAQ21> What are availability zones? </a>
* <a href=#FAQ22> How do I change my Credit Card information? </a>
* <a href=#FAQ23> How do EY Cloud instances differ from EY Managed slices? </a>
* <a href=#FAQ24> Unicorn failing to reload after Bundler </a>
* <a href=#FAQ25> Do you offer any DDoS Protection on Cloud? </a>
...
Only git is supported at this time. Your repository needs to be ported to git before your application can be deployed on Cloud. [[GitHub|http://github.com/guides/import-from-subversion]] has a great doc on porting an SVN repository to git. 

<a href=#FAQ2><h2 id="FAQ2"> Is there any shared storage on Cloud? </h2></a>

No. Shared storage (GFS) is not supported on Cloud. If your application stores dynamic assets in `/data`, you'll need to move these assets to a content delivery network (CDN) such as S3.

We currently do not have any plans to support a shared storage on Cloud. 

<a href=#FAQ3><h2 id="FAQ3"> Do you offer Email services on Cloud? </h2></a>

Email services are not offered on Cloud. If your application uses Engine Yard for email either inbound or outbound, you need to sign up with an external service provider. For applications which send a lot of mail we recommend SendGrid or authSMTP. For incoming, try Rackspace mail hosting. For lower volumes in either direction we recommend Google.
...
On our Classic Cloud it has been possible to have multiple domains, each with their own SSL certificate and IP address, all accessing the same application. This setup isn't supported on Cloud because Amazon EC2 instances can have only one IP address. 
...
<a href=#FAQ9><h2 id="FAQ9"> Is PostgreSQL supported on Cloud? </h2></a>

Cloud support for PostgreSQL 9 is an Alpha feature. For more information, see [[Engine Yard Beta Program|beta-intro]].  

<a href=#FAQ11><h2 id="FAQ11"> What scale of apps are appropriate for Cloud? </h2></a>

Cloud is our recommended deployment platform for users who want to scale from small to large scale web applications. It provides metered billing and advanced provisioning, monitoring and management workflows that make it ideal for:
...
<a href=#FAQ12><h2 id="FAQ12"> What types of applications run on Cloud? </h2></a>
...
Then it runs on Cloud.  See our [[Stack Page|http://www.engineyard.com/technology/stack]] for the latest version we support.

<a href=#FAQ13><h2 id="FAQ13"> Does Engine Yard manage my Domain Name or does my Company? </h2></a>

You setup and control the DNS records for your domain name of your website. You'll setup the IP address inside the Cloud application and then point your DNS to that IP address.
...
Read the [[IP Address Overview|ip-addresses]] article for more in-depth information about IP addresses and how they are used with Cloud.
...
Yes, you can upload your own SSH key to Cloud.  You can even specify keys which keys are used on which environments.
...
<a href=#FAQ20><h2 id="FAQ20"> Are there reserved names in Cloud? </h2></a>
...
For information about setting availability zones in Cloud, see [[Using multi-region on Cloud|using-multi-region-with-engine-yard-appcloud]].
...
<a href=#FAQ23><h2 id="FAQ23"> How do Cloud instances differ from Managed slices? </h2></a>

### What Instances and Slices Have in Common

Your Cloud instance closely resembles the Managed slices.

The hard work, detailed configuration, and battle-tested setup that have gone into building the [[Engine Yard Stack|http://www.engineyard.com/technology/stack]] serve as the foundation for each Cloud instance. 

### Convention over Configuration

We continue to use conventions developed on the Managed.  If you are familiar with an Engine Yard slice, you should feel at home.
...
<a href=#FAQ25><h2 id="FAQ25"> Do you offer any DDoS protection on Cloud? </h2></a>
...
This should make sure all API endpoints line up between the gem and the Cloud application.
