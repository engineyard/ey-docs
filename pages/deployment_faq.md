# Engine Yard CLI Deployment FAQs

* <a href="#FAQ1"> Can I use the CLI with multiple accounts? </a>
* <a href="#FAQ2"> How do I 'bundle lock' before doing a deploy? </a>
* <a href="#FAQ3"> How do I use the CLI with separate SSH keys for each project? </a>
* <a href="#FAQ4"> How do I avoid copying my large .git directory with every deploy? </a>
* <a href="#FAQ5"> Where is the deploy log? </a>
...
<h2 id="FAQ2"><a href="#FAQ2"> How do I 'bundle lock' before doing a deploy? </a></h2>
...
<h2 id="FAQ3"><a href="#FAQ3"> How do I use the CLI with separate SSH keys for each project? </a></h2>
...
<h2 id="FAQ4"><a href="#FAQ4"> How do I avoid copying my large .git directory with every deploy? </a></h2>
...
<h2 id="FAQ5"><a href="#FAQ5"> Where is the deploy log? </a></h2>
