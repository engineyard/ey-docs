...
You can configure many different applications and their corresponding repository URL and framework under Engine Yard Cloud.
  ...
  1. In your Cloud account, click on the Dashboard link.
...
Cloud deploy key is installed for this repository on GitHub. You can find your Cloud
deploy key on the application page referenced in step 3 above.


## A note about SVN
Currently Cloud only supports Git repositories for deployment.  If you use SVN you can now migrate to Git and continue to use your SVN workflow.  See [GitHub's documentation](http://help.github.com/svn-importing/) for an example, or check the documentation for your repository provider.
