...
3. Enter a name for your account.
    ...
    ![Create your Cloud account](images/tutorials/create_your_account_dash.png)
...
In general, you can use any git server with your Cloud account. However, in this tutorial, you use GitHub because the Fat Free CRM repository is on GitHub.  
...
1. If you are not already signed in to your Cloud account, log in now. [[cloud.engineyard.com/accounts|https://cloud.engineyard.com/accounts]]

2. In your Cloud account page, paste the URL into the Git Repository URI field.
...
7. In your Cloud account page, click My Deploy Key is in Place.
...
5. In your Cloud account page, click SSH Public Keys.
...
In this procedure, you update your Cloud environment for the Rails gem and the SSH key.

### To update your environment

1. In your Cloud account page, click Dashboard.
